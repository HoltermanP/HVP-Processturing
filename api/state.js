...
const SLEUTELS = ['werkpakketten', 'voortgang', 'doorlooptijden', 'snapshots', 'instellingen', 'vergunningen', 'risicos', 'gebruikers', 'toewijzingen', 'activiteitInfo', 'tsb', 'tolgates', 'tolgateInstances', 'wijzigingen', 'vtws'];
